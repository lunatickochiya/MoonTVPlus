...
export const UserMenu: React.FC = () => {
  ...
  useEffect(() => {
    if (isSettingsOpen || isChangePasswordOpen || isSubscribeOpen || isOfflineDownloadOpen) {
  ...
  }, [isSettingsOpen, isChangePasswordOpen, isSubscribeOpen, isOfflineDownloadOpen]);
